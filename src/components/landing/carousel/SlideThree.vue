...
import Img1 from '@/assets/images/landing-slide3.png';
import Img2 from '@/assets/images/landing-slide3-2.png';
...
export default {
  ...
  setup() {
    const word: WordDto = {
      ...
      tags: ['IT', 'WORK'],
      text: 'Develop',
      translations: ['Разрабатывать', 'Cовершенствовать', 'Развивать', 'Конструировать'],
