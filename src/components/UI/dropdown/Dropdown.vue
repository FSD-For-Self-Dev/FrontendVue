...
<template>
  <div class="dropdown" :class="dropdownClasses" @click="handleDropdownClick">
    <div class="selected-item">
      ...
      <svg-icon
        v-if="selected && selected.icon_component"
        v-bind:name="selected.icon_component"
        :color="selected.icon_component_custom_color"
        size="nm"
      />
    ...
    <svg-icon class="chevron" :class="chevronClasses" name="ArrowDownIcon" size="md" v-if="!noChevron" />
